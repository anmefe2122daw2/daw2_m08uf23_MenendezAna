        ...
        <div class="container">
            ...
            if (
                ...
                if ($ldap->add($dn, $nova_entrada)) {
                    ...
                    echo '<a href="http://zend-anmefe/ldap/afegirUsuari.php">Afegir un altre Usuari</a> <br />';
            ...
            ?>
                <div class="formldap">
                    <div class="form">
                        <form class="login-form" action="http://zend-anmefe/ldap/afegirUsuari.php" method="POST" autocomplete="off">
                            <h5>Cercar Usuari</h5>
