        ...
        <div class="container">
            ...
            if ($_POST['method'] == "PUT") {
                if ($_POST['uid'] && $_POST['ou'] && $_POST['radioValue'] && $_POST['nouContingut']) {
                    ...
                    echo '<a href="http://zend-anmefe/ldap/modificarUsuari.php">Modificar un altre Usuari</a> <br />';
                    echo '<a href="http://zend-anmefe/ldap/menu.php">Tornar a Inici</a>';
                }
            } else {
            ?>
                <div class="formldap">
                    <div class="form">
                        <form class="login-form" action="http://zend-anmefe/ldap/modificarUsuari.php" method="POST" autocomplete="off">
